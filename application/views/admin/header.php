    ...
    <div class="navbar">
        <div class="navbar-inner">
                <ul class="nav pull-right">
                    <li>
                        <a href="#" role="button">
                            <i class="icon-user"></i> <?php echo $this->session->username;
; ?>
                        </a>
                    </li>
                    <li><a href="<?php echo site_url('admin/user/logout'); ?>" class="hidden-phone visible-tablet visible-desktop" role="button"><?php if ($this->session->username) {
                       echo "退出";
                    } ?></a></li>
                </ul>
               <a class="brand" href="<?php echo site_url('admin/blog'); ?>"><span class="first">Blog</span> <span class="second">Admin</span></a>
        </div>
    </div>