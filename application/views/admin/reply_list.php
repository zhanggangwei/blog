                  ...
                  <table class="table">
                    ...
                    <?php foreach($info as $value){ ?>
                      <tr>
                        ...
                        <td><?php echo $value['reply_email']; ?></td>
                        <td><?php echo $value['reply_content']; ?></td>
                        <td><?php echo date("Y-m-d H:i",$value['reply_time']); ?></td>
                        <td>
                            <!-- <a href="<?php echo site_url('admin/reply/edit/'.$value['blog_id']); ?>"><i class="icon-pencil"></i></a> -->
                            <a href="<?php echo site_url('admin/reply/delete/'.$value['reply_id']); ?>" onclick="return confirm('确定要删除吗？')" role="button" data-toggle="modal"><i class="icon-remove"></i></a>
                        </td>
                      </tr>
                      <?php } ?>
                      <!-- <tr>
