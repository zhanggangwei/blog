    ...
    <div class="navbar">
        <div class="navbar-inner">
                <ul class="nav pull-right">
                    <li>
                        <a href="#" role="button">
                            <i class="icon-user"></i> <?php echo $this->session->user_name;
; ?>
                        </a>
                    </li>
                    <li><a href="<?php echo site_url('user/logout'); ?>" class="hidden-phone visible-tablet visible-desktop" role="button"><?php if ($this->session->user_name) {
                       echo "退出";
                    } ?></a></li>
                </ul>
               <a class="brand" href="<?php echo site_url('user_center/index'); ?>"><span class="first">User</span> <span class="second">Center</span></a>
        </div>
    </div>